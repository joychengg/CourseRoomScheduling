...
describe("InsightFacadeTest", function () {
    ...
    it("apply with sum", function () {
        this.timeout(200000);
        return insightFacade.performQuery(ApplyWithSum).then(function (value) {
            Log.test('Value: ' + value.code);
            //console.log(value.body);
            expect(value.code).to.equal(200);
            console.log(JSON.stringify(value.body));
           // expect(value.body).to.deep.equal(SumResult);
